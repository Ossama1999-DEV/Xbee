...
TRISD = 0x00100000;               // Configure D5 en entrée et les autres en sorties*/
...
xbee (1, point) ;
LongIntToStrWithZeros(temp.decimal * 625, msg); // Convertit la partie décimale de la température en chaîne (String).
Lcd_Out_CP(msg + 7);             //ignorer les 2 espaces vides au début de la chaîne.
 xbee(7,msg +7  );
 xbee(1,saut);
